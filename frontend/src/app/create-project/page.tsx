...
export default function ForgeArchitectOnboarding() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-3 bg-white/[0.03] border border-white/[0.08] rounded-full px-4 py-2 backdrop-blur-xl">
          ...
          <motion.div
            ...
            className="flex items-center gap-1.5 bg-orange-500/12 border border-orange-500/30 rounded-full px-3.5 py-[5px] text-orange-500 font-mono text-[11px] font-semibold tracking-[0.08em]"
          >
            <Zap size={12} />
      ...
      {/* Main */}
      <main className="flex-1 flex items-center gap-10 px-6 py-10 sm:px-10 md:px-16 relative z-[5] max-w-[1100px] w-full mx-auto
      ...
      ">
        ...
        <motion.aside
          ...
          className="flex flex-col justify-between gap-8 w-full md:w-[280px] md:shrink-0"
        >
          <div>
            <motion.p
              initial={{ opacity: 0 }}
            ...
            <motion.div
              ...
              className="hidden sm:block bg-white/[0.03] border border-white/[0.07] rounded-[10px] p-4"
            >
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[11px] font-bold tracking-[0.1em] text-white/70 font-mono">NODE: ALPHA-7</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[11px] font-bold tracking-[0.1em] text-white/70 font-mono">COMPUTE: ALLOCATED</p>
        ...
        <motion.section
          ...
          className="relative flex-1 w-full bg-white/[0.025] border border-white/[0.08] rounded-2xl overflow-hidden backdrop-blur-lg"
        >
          {/* Corner brackets */}
          {[
          ...
          <div className="p-6 sm:p-9 flex flex-col gap-9">
            ...
            <div className="flex flex-col gap-2.5">
              <div className="flex justify-between items-center">
                ...
                <span className="text-[10px] tracking-[0.1em] text-orange-500/50 font-mono">01_INIT_10</span>
              </div>
                ...
                <AnimatePresence>
                  {projectName && (
                    <motion.div
                      ...
                      className="w-[7px] h-[7px] rounded-full bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.6)] shrink-0"
                    />
                  )}
                </AnimatePresence>
              </motion.div>
            ...
            <div className="flex flex-col gap-3.5">
              <motion.button
                ...
                className={`
                  relative w-full py-[18px] px-6 rounded-[10px] overflow-hidden
      ...
      <motion.footer
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 1 }}
        className="relative z-10 flex justify-between items-center px-6 sm:px-8 py-3.5 border-t border-white/[0.05] flex-wrap gap-2.5"
      >
          ...
          {[
            ...
            <div key={label} className="flex items-center gap-2 text-orange-500/50">
              ...
              <div>
                ...
                <p className="text-[10px] tracking-[0.1em] text-orange-500 font-mono">{value}</p>
              </div>
            </div>
          ))}
        </div>
